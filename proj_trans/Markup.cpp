...
bool CMarkup::GetChildDataDouble(std::string srctag, std::string dsttag, double &value)
{
	if(srctag == dsttag)
	{
		value = atof(GetChildData().c_str());
		return true;
	}
	return false;
}

bool CMarkup::GetChildDataInt(std::string srctag, std::string dsttag, int &value)
{
	if(srctag == dsttag)
	{
		value = atoi(GetChildData().c_str());
		return true;
	}
	return false;
}

bool CMarkup::GetChildDataString(std::string srctag, std::string dsttag, std::string &value)
{
	if(srctag == dsttag)
	{
		value = GetChildData();
...
bool CMarkup::GetDataDouble(std::string srctag, std::string dsttag, double &value)
{
	if(srctag == dsttag)
	{
		value = atof(GetData().c_str());
		return true;
	}
	return false;
}

bool CMarkup::GetDataInt(std::string srctag, std::string dsttag, int &value)
{
	if(srctag == dsttag)
	{
		value = atoi(GetData().c_str());
		return true;
	}
	return false;
}

bool CMarkup::GetDataString(std::string srctag, std::string dsttag, std::string&value)
{
	if(srctag == dsttag)
	{
		value = GetData();
...
void CMarkup::GetChildAttribString(std::string szAttrib, std::string &value)
{
	value = GetChildAttrib(szAttrib);
}

void CMarkup::GetChildAttribDouble(std::string szAttrib, double &value)
{
	value = atof(GetChildAttrib(szAttrib).c_str());
}

void CMarkup::GetChildAttribInt(std::string szAttrib, int &value)
{
	value = atoi(GetChildAttrib(szAttrib).c_str());
}

void CMarkup::GetAttribString(std::string szAttrib, std::string &value)
{
	value = GetAttrib(szAttrib);
}

void CMarkup::GetAttribDouble(std::string szAttrib, double &value)
{
	value = atof(GetAttrib(szAttrib).c_str());
}

void CMarkup::GetAttribInt(std::string szAttrib, int &value)
{
	value = atoi(GetAttrib(szAttrib).c_str());
}
