...
public:
	...
	//自己添加的方便读取的函数
	//{
	bool GetChildDataDouble(std::string srctag, std::string dsttag, double &value);
	bool GetChildDataInt(std::string srctag, std::string dsttag, int &value);
	bool GetChildDataString(std::string srctag, std::string dsttag, std::string &value);
	bool GetDataDouble(std::string srctag, std::string dsttag, double &value);
	bool GetDataInt(std::string srctag, std::string dsttag, int &value);
	bool GetDataString(std::string srctag, std::string dsttag, std::string &value);
	void GetChildAttribString(std::string szAttrib, std::string &value);
	void GetChildAttribDouble(std::string szAttrib, double &value);
	void GetChildAttribInt(std::string szAttrib, int &value);
	void GetAttribString(std::string szAttrib, std::string &value);
	void GetAttribDouble(std::string szAttrib, double &value);
	void GetAttribInt(std::string szAttrib, int &value);
	//}
	...
	//////////////////////////////////////////////////////////////////////////
	//int GetCurrentLevel() const { return ElemPos.Level(); };
	//////////////////////////////////////////////////////////////////////////
	enum MarkupDocFlags
	{
		MDF_IGNORECASE = 8,
